...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"التالي",sPrevious:"السابق"},sEmptyTable:"No data available in table",sInfo:"عرض _START_ to _END_ of _TOTAL_ الإدخالات",sInfoEmpty:"عرض 0 to 0 of 0 الإدخالات",sInfoFiltered:"(filtered from _MAX_ total الإدخالات)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"عرض _MENU_ الإدخالات",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"بحث:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
