    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div style="height: 1px; background-color: #fff; text-align: center">
                  <span style="background-color:#fff; position: relative; top: -12px; font-size:16px;padding:0px 8px;">
                    <?php echo lang_key('Login with email');?>
                  </span>
                </div>
                <br>
                <form action="<?php echo site_url('account/login');?>" method="post">
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a style="margin:10px 0 0 10px;" href="<?php echo site_url('account/register');?>"><?php echo lang_key('Register'); ?></a><a style="margin-left:10px;" href="<?php echo site_url('account/recoverpassword');?>"><?php echo lang_key('Recover');?></a>
                        </div>
                     </div>
                </form>
            </div>
...
<div id="myModal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="myModalLabel"><?php echo lang_key('Register');?> </h4>
            </div>
            <div class="modal-body">
                <?php 
                 if($fb_enabled=='Yes' || $gplus_enabled=='Yes'){
                ...
                <div style="height: 1px; background-color: #fff; text-align: center">
                  <span style="background-color:#fff; position: relative; top: -12px; font-size:16px;padding:0px 8px;">
                    Signup with social account NOWWW
                  </span>
                </div>
                <div style="text-align:center;">
                    <br>
                ...
                <div style="height: 1px; background-color: #fff; text-align: center">
                  <span style="background-color:#fff; position: relative; top: -12px; font-size:16px;padding:0px 8px;">
                    <?php echo lang_key('Signup with email');?>
                  </span>
                </div>
                <br>
                <form action="<?php echo site_url('account/register');?>" method="post">
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-12">
                            <select name="gender" class="form-control">
                                <option value="male"><?php echo lang_key('Male');?></option>
                                <option value="female"><?php echo lang_key('Female');?></option>
                            </select>    
                        </div>
                     </div>
                     <div class="row">
                     ...
                     <div class="row">
                        <div class="col-sm-3" style="padding-top:7px;font-weight:bold;">
                            <?php echo lang_key('Retype Password');?>
                        </div>
                        <div class="col-sm-12">
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                            <button type="submit" class="btn btn-primary pull-left"> <?php echo lang_key('Register'); ?></button>
                            <a style="margin:10px 0 0 10px;" href="<?php echo site_url('account/trylogin');?>"><?php echo lang_key('Login'); ?></a><a style="margin-left:10px;" href="<?php echo site_url('account/recoverpassword');?>"><?php echo lang_key('Recover'); ?></a>
                        </div>
                     </div>
                </form>
            </div>
