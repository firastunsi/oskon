<h1 class="recent-grid"><span class="OS_icon_f"><i class="fa fa-sign-in"></i></span>&nbsp;<?php echo lang_key('register') ?></h1>
<div class="row">
    <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            <?php if(get_settings('realestate_settings','enable_pricing','Yes')=='Yes'){?>    
                                <div class="thumbnail thumb-shadow">                                    
                                    <div class="caption">
                                        <h4 class="package-title"><?php echo lang_key($package->title);?></h4> 
                                        <div class="OS_pack_pa"> <p><?php echo lang_key($package->description);?></p>                       
                                        <div style="clear:both;">
                                            <span style="float:left; font-weight:bold;" class="ar_div"><?php echo lang_key('price') ?>:</span>
                                            <span style="float:right; ">
                                                 <?php if ($package->price != 0):?>
                                                   <?php echo show_package_price($package->price);?>
                                                <?php else:?>
                                                    <?php echo lang_key('Free');?>
                                                <?php endif;?>
                                            </span>
                                        </div>
                                        <div style="clear:both; border-bottom:1px solid #ccc; margin:10px 0px;"></div>
                                        <div style="clear:both;">
                                            <span style="float:left; font-weight:bold;" class="ar_div"><?php echo lang_key('limit') ?>:</span>
                                            <span style="float:right; ">
                                                <?php if ($package->price != 0):?>
                                        ...
                                        <div style="clear:both; border-bottom:1px solid #ccc; margin:10px 0px;"></div>
                                        <div style="clear:both;">
                                            <span style="float:left; font-weight:bold;" class="ar_div"><?php echo lang_key('usage') ?>:</span>
                            ...
                            <form action="<?php echo site_url('account/register/');?>" method="post">
                                ...
                                <div class="top-margin">
                                    <label><?php echo lang_key('Username');?> <span class="text-danger">*</span></label>
                                ...
                                <span class="company-holder">
                                <div class="top-margin">
                                    <label><?php echo lang_key('company_address'); ?> <span class="text-danger">*</span></label>
                                    <input type="text" name="company_address" value="<?php echo set_value('company_address');?>" class="form-control">
                                </div>
...
<!--                                    <div class="col-lg-8">
                                        ...
                                        <label class="checkbox">
                                            ...
                                            <?php //echo lang_key('I\'ve read the');?> <a target="_blank" href="<?php echo site_url('show/terms');?>"><?php echo lang_key('Terms & Conditions');?></a>
                                        </label>
