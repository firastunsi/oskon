<h1 class="recent-grid"><span class="OS_icon_f"><i class="fa fa-check"></i></span>&nbsp;<?php echo lang_key('confirmation'); ?></h1>
<div class="row">
    <div class="col-md-12" style="min-height:300px">
        <div class="p_p_monye"> <?php echo lang_key('Package price');?> : <?php echo show_package_price($this->session->userdata('amount'));?></div>
        <p class="d_info"><?php echo lang_key('payment_notification'); ?></p>
        ...
        <?php if(get_settings('realestate_settings','enable_paypal_transfer','Yes')=='Yes'){?>
            ...
            <button type="submit" class="btn btn-primary"><?php echo lang_key('Go to Paypal');?></button>
